...
public class ImagePipelineConfigUtils {
    ...
    //小图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = VideoPlayerGlobals.FRESCO_CACHE;
    //默认图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_CACHE_DIR = VideoPlayerGlobals.FRESCO_CACHE;
