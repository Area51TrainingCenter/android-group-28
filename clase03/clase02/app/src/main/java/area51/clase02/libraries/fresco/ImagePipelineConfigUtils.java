package org.legasys.android.employees.libraries.images;
...
import org.legasys.android.employees.core.LegasysGlobals;
...
public class ImagePipelineConfigUtils {
    ...
    //默认图极低磁盘空间缓存的最大值
    private static final int MAX_DISK_CACHE_VERYLOW_SIZE = 2 * ByteConstants.MB;
    //默认图低磁盘空间缓存的最大值
    ...
    //小图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = LegasysGlobals.FRESCO_CACHE;
    //默认图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_CACHE_DIR = LegasysGlobals.FRESCO_CACHE;
